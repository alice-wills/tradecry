    ...
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <div className="flex-grow text-gray-800">
        ...
        <main className="p-6 sm:p-10 space-y-6">
          <div className="mr-6">
            <h1 className="text-4xl font-semibold mb-2">User Profile</h1>
          </div>
          ...
          <div className="landing-page animate__animated  animate__fadeIn">
            <div className=" bg-gray-100 flex items-center justify-center">
              <div className="bg-white shadow-lg rounded-lg p-6 w-full ">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600 flex items-center">
                        ...
                        >
                          <path d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm0 15l4-4-1.41-1.41L12 14.17l-2.59-2.58L8 13l4 4z"></path>
                        </svg>
                        Un-Verified Account
                      </p>
                    </div>
                ...
                <div className="mt-6">
                  <h3 className="text-gray-800 font-medium">Account Details</h3>
                  <div className="mt-4">
                    <div className="flex items-center justify-between border-b py-2">
                      <span className="text-gray-600">Email:</span>
                      <span className="text-gray-800">sado@gmail.com</span>
                    </div>
                    <div className="flex items-center justify-between border-b py-2">
                      <span className="text-gray-600">Phone:</span>
                      <span className="text-gray-800">+2347069658824</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  <button className="bg-red-500 text-white font-medium py-2 px-4 rounded-lg hover:bg-red-600">
                    Logout
                  </button>
                </div>
              </div>
