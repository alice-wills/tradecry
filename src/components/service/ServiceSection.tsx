...
const ServiceSection = () => {
  return (
    <div className="w-full float-left pb-[90px] pt-[100px]">
      <div className="w-full pr-[15px] pl-[15px] mr-auto ml-auto">
        ...
        <div className="w-full float-left pt-[90px]">
          <div className="flex flex-wrap mr-[-15px] ml-[-15px]">
            <div className="flex-[0_0_33.333333%] max-w-[33.333333%] w-full relative min-h-[1px] pr-[15px] pl-[15px]">
              <div className="text-center justify-center items-center mx-auto flex w-full">
                <Image alt="" src="/payment.png" width={100} height={100} />
              </div>
              <h3 className="w-full float-left text-[30px] text-[#000] font-bold text-center pt-[20px]">PAYMENT OPTIONS</h3>
              <p className="w-[90%] mx-auto text-[16px] text-[#000] text-center justify-center items-center ">
            ...
            <div className="flex-[0_0_33.333333%] max-w-[33.333333%] w-full relative min-h-[1px] pr-[15px] pl-[15px]">
              ...
              <h3 className="w-full float-left text-[30px] text-[#000] font-bold text-center pt-[20px]">STRONG SECURITY</h3>
              <p className="w-[90%] mx-auto text-[16px] text-[#000] text-center justify-center items-center">
            ...
            <div className="flex-[0_0_33.333333%] max-w-[33.333333%] w-full relative min-h-[1px] pr-[15px] pl-[15px]">
              ...
              <h3 className="w-full float-left text-[30px] text-[#000] font-bold text-center pt-[20px]">WORLD COVERAGE</h3>
              <p className="w-[90%] mx-auto text-[16px] text-[#000] text-center justify-center items-center">
            ...
            <div className="flex-[0_0_33.333333%] max-w-[33.333333%] w-full relative min-h-[1px] pr-[15px] pl-[15px]">
              ...
              <h3 className="w-full float-left text-[30px] text-[#000] font-bold text-center pt-[20px]">EXPERIENCED TEAM</h3>
              <p className="w-[90%] mx-auto text-[16px] text-[#000] text-center justify-center items-center">
            ...
            <div className="flex-[0_0_33.333333%] max-w-[33.333333%] w-full relative min-h-[1px] pr-[15px] pl-[15px]">
              ...
              <h3 className="w-full float-left text-[30px] text-[#000] font-bold text-center pt-[20px]">ADVANCED REPORTING</h3>
              <p className="w-[90%] mx-auto text-[16px] text-[#000] text-center justify-center items-center">
            ...
            <div className="flex-[0_0_33.333333%] max-w-[33.333333%] w-full relative min-h-[1px] pr-[15px] pl-[15px]">
              ...
              <h3 className="w-full float-left text-[30px] text-[#000] font-bold text-center pt-[20px]">CROSS-PLATFORM TRADING</h3>
              <p className="w-[90%] mx-auto text-[16px] text-[#000] text-center justify-center items-center">
            ...
            <div className="flex-[0_0_33.333333%] max-w-[33.333333%] w-full relative min-h-[1px] pr-[15px] pl-[15px]">
              ...
              <h3 className="w-full float-left text-[30px] text-[#000] font-bold text-center pt-[20px]">EXPERT SUPORT</h3>
              <p className="w-[90%] mx-auto text-[16px] text-[#000] text-center justify-center items-center">
            ...
            <div className="flex-[0_0_33.333333%] max-w-[33.333333%] w-full relative min-h-[1px] pr-[15px] pl-[15px]">
              ...
              <h3 className="w-full float-left text-[30px] text-[#000] font-bold text-center pt-[20px]">INSTANT EXCHANGE</h3>
              <p className="w-[90%] mx-auto text-[16px] text-[#000] text-center justify-center items-center">
